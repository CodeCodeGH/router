...
<div class="bezel" id="bezel-id" style="height:800px">
    <div class="head" style="height:9.39%;">
    ...
    <div class="center">
        <div class="cleft" id="cleft-id">	
            ...
            <li  <?php  if($action=="avshow"){ echo " class='on' " ;} ?> ><a href="<?php echo $this->createUrl('appversion/avshow') ?>">App升级</a></li>
