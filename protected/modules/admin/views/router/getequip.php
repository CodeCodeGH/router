        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <table class="table table-hover table-striped">
                    ...
                    <?php  if(!empty($E_data)){  ?>
                    <?php foreach($E_data  as $EVal){  ?>
                    <tr>
                        <td class="text-center"><?php echo $EVal->id ?></td>
                        <td class="text-center"><?php echo $EVal->router_equipment_id ?></td>
                        <td class="text-center"><?php echo $EVal->router_id ?></td>
                        <td class="text-center">
                            <?php 
                              $router_equipment_id=$EVal->router_equipment_id;
                        ...
                        <td class="text-center"><?php echo $EVal->ctime ?></td>
                        <td class="text-center"><?php echo $EVal->mtime ?></td>
                        <td class="text-center">
                            <a href="<?php echo $this->createUrl('admin/admindetail',array('admin_id'=>$EVal->id)) ?>" type="button" class="btn btn-danger">删除</a>
                            <a href="<?php echo $this->createUrl('admin/admindetail',array('admin_id'=>$EVal->id)) ?>" type="button" class="btn btn-info">查看详情</a>
                        </td>
                    </tr>
                    <?php }  ?>
                    <!-- 页码 -->
