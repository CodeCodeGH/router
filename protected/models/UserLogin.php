 ...
 * @property string $current_equipment
...
class UserLogin extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_id, current_ip, current_equipment, ctime, mtime', 'required'),
			array('user_id', 'numerical', 'integerOnly'=>true),
			array('current_ip, current_equipment', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, user_id, current_ip, current_equipment, ctime, mtime', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('current_equipment',$this->current_equipment,true);
