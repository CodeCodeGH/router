...
class Version extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('version_number, version_url, ctime, mtime', 'required'),
			array('version_number, version_url', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, version_number, version_url, ctime, mtime', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('version_url',$this->version_url,true);
